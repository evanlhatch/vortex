...
fn optimize_then_execute(
    ...
    let expected = expected
        ...
        .execute::<Canonical>(&mut execution_ctx())?
        .into_array();
    assert_arrays_eq!(executed.output, expected);
    Ok([
        Traced {
...
fn trace_scan_compare_on_compressed_shipdate() -> VortexResult<()> {
    ...
    execute_until target=AnyCanonical root=vortex.binary(bool, len=4096)
      iter 0 current=vortex.binary(bool, len=4096) builder_active=false
        child_execute_parent static:kernel[0] slot=0 parent=vortex.binary(bool, len=4096) child=vortex.ext(vortex.date[days](i32), len=4096) -> vortex.binary(bool, len=4096)
      iter 1 current=vortex.binary(bool, len=4096) builder_active=false
    optimize root=vortex.cast(i32?, len=4096) session=false
      optimize root=vortex.cast(i32?, len=4096) session=false
        reduce_parent static:CastReduceAdaptor(BitPacked) slot=0 parent=vortex.cast(i32?, len=4096) child=fastlanes.bitpacked(i32, len=4096) -> fastlanes.bitpacked(i32?, len=4096)
        done output=fastlanes.bitpacked(i32?, len=4096)
      reduce_parent static:CastReduceAdaptor(FoR) slot=0 parent=vortex.cast(i32?, len=4096) child=fastlanes.for(i32, len=4096) -> fastlanes.for(i32?, len=4096)
...
fn trace_scan_compare_on_compressed_quantity() -> VortexResult<()> {
    ...
    optimize root=vortex.binary(bool, len=4096) session=false
      reduce_parent static:DictionaryScalarFnValuesPushDownRule slot=0 parent=vortex.binary(bool, len=4096) child=vortex.dict(i16, len=4096) -> vortex.dict(bool, len=4096)
        ...
        child_execute_parent static:kernel[0] slot=0 parent=vortex.binary(bool, len=4096) child=vortex.decimal_byte_parts(decimal(15,2), len=4096) -> vortex.dict(bool, len=4096)
    ...
    optimize root=vortex.cast(i16?, len=50) session=false
      reduce_parent static:CastReduceAdaptor(Sequence) slot=0 parent=vortex.cast(i16?, len=50) child=vortex.sequence(i16, len=50) -> vortex.sequence(i16?, len=50)
      done output=vortex.sequence(i16?, len=50)
    ...
    optimize root=vortex.cast(i16?, len=1) session=false
      reduce_parent static:CastReduceAdaptor(Constant) slot=0 parent=vortex.cast(i16?, len=1) child=vortex.constant(i16, len=1) -> vortex.constant(i16?, len=1)
      done output=vortex.constant(i16?, len=1)
    execute_until target=AnyCanonical root=vortex.constant(i16?, len=1)
      ...
      iter 7 current=vortex.dict(bool, len=4096) builder_active=false
        child_execute_parent static:kernel[2] slot=1 parent=vortex.dict(bool, len=4096) child=vortex.bool(bool, len=50) -> vortex.bool(bool, len=4096)
...
fn trace_scan_compare_on_compressed_shipmode() -> VortexResult<()> {
    ...
    execute_until target=AnyCanonical root=vortex.dict(bool, len=4096)
      ...
      iter 4 current=vortex.binary(bool, len=7) stack_parent=vortex.dict(bool, len=4096) slot=1 builder_active=false
        child_execute_parent static:kernel[1] slot=0 parent=vortex.binary(bool, len=7) child=vortex.fsst(utf8, len=7) -> vortex.binary(bool, len=7)
      iter 5 current=vortex.binary(bool, len=7) stack_parent=vortex.dict(bool, len=4096) slot=1 builder_active=false
    execute_until target=AnyCanonical root=vortex.cast(i32, len=8)
      iter 0 current=vortex.cast(i32, len=8) builder_active=false
        child_execute_parent static:kernel[1] slot=0 parent=vortex.cast(i32, len=8) child=vortex.primitive(u8, len=8) -> vortex.primitive(i32, len=8)
      iter 1 current=vortex.primitive(i32, len=8) builder_active=false
      return output=vortex.primitive(i32, len=8)
        child_execute_parent static:kernel[1] slot=0 parent=vortex.binary(bool, len=7) child=vortex.varbin(binary, len=7) -> vortex.bool(bool, len=7)
      iter 6 current=vortex.bool(bool, len=7) stack_parent=vortex.dict(bool, len=4096) slot=1 builder_active=false
        pop_frame slot=1 output=vortex.dict(bool, len=4096)
      iter 7 current=vortex.dict(bool, len=4096) builder_active=false
        child_execute_parent static:kernel[2] slot=1 parent=vortex.dict(bool, len=4096) child=vortex.bool(bool, len=7) -> vortex.bool(bool, len=4096)
      iter 8 current=vortex.bool(bool, len=4096) builder_active=false
      return output=vortex.bool(bool, len=4096)
    ");
...
fn trace_scan_like_on_compressed_comment() -> VortexResult<()> {
    ...
    execute_until target=AnyCanonical root=vortex.like(bool, len=4096)
      iter 0 current=vortex.like(bool, len=4096) builder_active=false
        child_execute_parent static:kernel[4] slot=0 parent=vortex.like(bool, len=4096) child=vortex.fsst(utf8, len=4096) -> vortex.bool(bool, len=4096)
