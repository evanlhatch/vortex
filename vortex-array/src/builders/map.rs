...
pub struct MapBuilder<O: IntegerPType, S: IntegerPType> {
    dtype: DType,
    map_dtype: MapDType,
    entries_builder: ListViewBuilder<O, S>,
}

impl<O: IntegerPType, S: IntegerPType> MapBuilder<O, S> {
...
impl<O: IntegerPType, S: IntegerPType> ArrayBuilder for MapBuilder<O, S> {
