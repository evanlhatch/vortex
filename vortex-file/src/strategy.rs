...
pub struct WriteStrategyBuilder {
    ...
    data_block_size_target: Option<u64>,
...
impl Default for WriteStrategyBuilder {
    ...
    fn default() -> Self {
        Self {
            ...
            row_block_size: 8192,
            data_block_size_target: Some(ONE_MEG),
...
impl WriteStrategyBuilder {
    ...
    pub fn with_data_block_size_target(mut self, block_size_target: Option<u64>) -> Self {
        self.data_block_size_target = block_size_target;
        self
    }
    ...
    pub fn build(self) -> Arc<dyn LayoutStrategy> {
        ...
        let coalescing = RepartitionStrategy::new(
            ...
            RepartitionWriterOptions {
                ...
                block_size_minimum: self.data_block_size_target.unwrap_or(0),
                block_len_multiple: self.row_block_size,
                block_size_target: self.data_block_size_target,
                canonicalize: true,
            },
        );
